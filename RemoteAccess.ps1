...
# Disable "Meet now", the Search box, Cortana, and turn off "News and interests"
####################
# i.e. remove all junk from the Taskbar
...
# News and interests: Long method, but comprehensive for silent configuration settings
